...
demo::MainScreen::MainScreen(nador::IUiApp* uiApp, std::shared_ptr<nador::Font> font)
: _uiApp(uiApp)
{
    ...
    _menuButtons[0] = std::make_shared<MenuButton>(glm::ivec2{0, 300}, glm::ivec2{300, 100}, alignment, font, "start", nador::video::EImageName::MARIO1);
    _menuButtons[1] = std::make_shared<MenuButton>(glm::ivec2{0, 400}, glm::ivec2{300, 100}, alignment, font, "options", nador::video::EImageName::MARIO1);
    _menuButtons[2] = std::make_shared<MenuButton>(glm::ivec2{0, 500}, glm::ivec2{300, 100}, alignment, font, "exit", nador::video::EImageName::MARIO1);
