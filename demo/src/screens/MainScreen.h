...
namespace demo
{
    ...
    {
        MenuButton(const glm::ivec2& position, const glm::ivec2& size, nador::UiAlignment alignment, const nador::FontPtr& font, std::string_view text, nador::video::EImageName imageName)
    ...
    {
    public:
        MainScreen(nador::IUiApp* uiApp, std::shared_ptr<nador::Font> font);
        ~MainScreen();
